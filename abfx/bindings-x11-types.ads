...
package Bindings.X11.Types is
   ...
   type Destroy_Image_Type is access function
     (image : XImage_Pointer) return int;
   type Get_Pixel_Type is access function
     (image : XImage_Pointer;
      x, y  : int) return unsigned_long;
   type Put_Pixel_Type is access function
     (image : XImage_Pointer;
      x, y  : int;
      p     : unsigned_long) return int;
   type Sub_Image_Type is access function
     (image         : XImage_Pointer;
      x, y          : int;
      width, height : unsigned) return XImage_Pointer;
   type Add_Pixel_Type is access function
     (image : XImage_Pointer;
      p     : long) return int;
   ...
   type Resource_Alloc_Type is access function
     (d : Display_Pointer) return XID_Type;

   type Private15_Type is access function return chars_ptr;
   ...
   type XSizeHints_Pointer is access XSizeHints;
   ...
   type XWMHints is record
      ...
      icon_window   : Window_Type;
      icon_x        : int;
      icon_y        : int;
      icon_mask     : Pixmap_Type;
      window_group  : XID_Type;
   end record;
   pragma Convention (C, XWMHints);

   type XWMHints_Pointer is access XWMHints;
   ...
   type XClassHint_Pointer is access XClassHint;
