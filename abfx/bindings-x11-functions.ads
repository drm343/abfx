...
package Bindings.X11.Functions is
   ...
   procedure Xutf8SetWMProperties
     (display      : Display_Pointer;
      w            : Window_Type;
      text_prop    : chars_ptr;
      icon_name    : chars_ptr          := Null_Ptr;
      argv         : chars_ptr          := Null_Ptr;
      argc         : int                := 0;
      normal_hints : XSizeHints_Pointer := null;
      wm_hints     : XWMHints_Pointer   := null;
      class_hints  : XClassHint_Pointer := null);
   pragma Import (C, Xutf8SetWMProperties, "Xutf8SetWMProperties");
   ...
   function XLoadFont
     (display : Display_Pointer;
      name    : chars_ptr) return Font_Type;
   ...
   function XCreateGC
     (display   : Display_Pointer;
      ...
      values    : XGCValues_Pointer) return GC_Type;
   pragma Import (C, XCreateGC, "XCreateGC");

   function XFreeGC (display : Display_Pointer; g : GC_Type) return int;
   ...
   function XSetBackground
     (display : Display_Pointer;
      g       : GC_Type;
      color   : unsigned_long) return int;
